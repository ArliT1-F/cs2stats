        ...
        {top3.map((w, i) => (
          <div key={w.name} className="relative overflow-hidden border border-cs-border bg-cs-panel p-4 clip-corner">
            ...
            <div className="flex items-center gap-4">
              ...
              >
                <WeaponIcon name={w.name} internalKey={w.key} className="relative max-h-full max-w-full object-contain" size={128} />
              </div>
                    ...
                    <td className="py-2 pr-2">
                      <div className="flex items-center gap-3">
                        <div className="flex h-10 w-16 flex-shrink-0 items-center justify-center overflow-hidden bg-cs-bg/60 px-1">
                          <WeaponIcon name={w.name} internalKey={w.key} className="max-h-full max-w-full object-contain" size={64} />
                        </div>
