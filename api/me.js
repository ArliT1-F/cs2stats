...
import { buildFaceitDemoInfo } from "./_faceitDemos.js";
...
async function handleDiagnostics(req, res, steamId, STEAM_KEY) {
  const out = {
    cookieFound: !!steamId,
...
export default async function handler(req, res) {
  ...
  if (debugDiagnostics) {
    return handleDiagnostics(req, res, steamId, STEAM_KEY);
  }
